...
function getTitle( $title )
{
	...
	{
		case "pousada":
			$html .="<title>".getLabel('LABEL_APOUSADA', $_SESSION['LANGUAGE'])."  - ".getLabel('LABEL_TITLE_APOUSADA', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])."</title>";
		break;
		case "acomodacoes":
			$html .="<title>".getLabel('LABEL_QUARTOS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_QUARTOS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])." </title>";
		break;		
		case "reservas.form.submit":
			$html .="<title>".getLabel('LABEL_RESERVAS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_QUARTOS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])."</title>";
		break;
		...
		case "eventos-e-casamentos":
			$html .="<title>".getLabel('LABEL_EVENTOSECASAMENTOS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_EVENTOS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])."</title>";
		break;
		case "tarifas-e-promocoes":
			$html .="<title>".getLabel('LABEL_TARIFASEPROMOCOES', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_TARIFAS', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])."</title>";
		break;
		case "localizacao":
			$html .="<title>".getLabel('LABEL_LOCALIZACAO', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_LOCALIZACAO', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])."</title>";
		break;
		case "galeria":
			$html .="<title>".getLabel('LABEL_GALERIA', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_GALERIA', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])."</title>";
		break;
		default:
			$html .="<title>".getLabel('LABEL_POUSADA_MARAVISTA', $_SESSION['LANGUAGE'])." - ".getLabel('LABEL_TITLE_HOME', $_SESSION['LANGUAGE'])."</title>";
		break;
	}	
...
function getMenu($action)                                                                      
{
	$li = "<div class='Mainmenu'>";
		...
		$li .= "<div class='LinksMenu' title='".getLabel('LABEL_APOUSADA', $_SESSION['LANGUAGE'])."'><a href='$action/pousada'>".getLabel('LABEL_APOUSADA', $_SESSION['LANGUAGE'])."</a></div>";
		$li .= "<div class='LinksMenu' title='".getLabel('LABEL_QUARTOS', $_SESSION['LANGUAGE'])."'><a href='$action/acomodacoes'>".getLabel('LABEL_QUARTOS', $_SESSION['LANGUAGE'])."</a></div>";
		$li .= "<div class='LinksMenu' title='".getLabel('LABEL_EVENTOSECASAMENTOS', $_SESSION['LANGUAGE'])."'><a href='$action/eventos-e-casamentos'>".getLabel('LABEL_EVENTOSECASAMENTOS', $_SESSION['LANGUAGE'])."</a></div>";
		$li .= "<div class='LinksMenu' title='".getLabel('LABEL_TARIFAS', $_SESSION['LANGUAGE'])."'><a href='$action/tarifas'>".getLabel('LABEL_TARIFAS', $_SESSION['LANGUAGE'])."</a></div>";
            $li .= "<div class='LinksMenu' title='".getLabel('LABEL_PACOTESEPROMOCOES', $_SESSION['LANGUAGE'])."'><a href='$action/pacotes-e-promocoes'>".getLabel('LABEL_PACOTESEPROMOCOES', $_SESSION['LANGUAGE'])."</a></div>";
		$li .= "<div class='LinksMenu' title='".getLabel('LABEL_LOCALIZACAO', $_SESSION['LANGUAGE'])."'><a href='$action/localizacao'>".getLabel('LABEL_LOCALIZACAO', $_SESSION['LANGUAGE'])."</a></div>";
...
{                                                                                              
	...
	{                                                                                          
		...
		$html .= "<div style='width: 22px; position: relative; top: 3px;'><img src='http://www.maravista.com.br/image/casa.png' width='80%'/>&nbsp;&nbsp;</div>";
		$html .= "<div onclick=\" window.location = '../$myhotsite' \"><span style='position: relative; bottom: 9px;'>MEU HOTSITE</span>&nbsp;&nbsp;&nbsp;<img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
		$html .= "<div onclick=\" window.location = '../index.php?actionType=pagina.inicial' \"><span style='position: relative; bottom: 9px;'>AGORA F¡CIL</span>&nbsp;&nbsp;&nbsp;<img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
		...
		{                                                                                      
			...
			{                                                                                  
				$html .= "<div onclick=\" location = '../index.php?actionType=produtos&codpessoa=$codigos->CODPESSOA&codempresa=$codigos->CODEMPRESA'\">&nbsp;&nbsp;<span style='position: relative; bottom: 9px;'>MEUS PRODUTOS</span>&nbsp;&nbsp;&nbsp;<img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
			}                                                                                  
		}                                                                                      
		                                                                                       
		//$html .= "<div onclick=\" location = '../index.php?actionType=agenda'\">&nbsp;&nbsp;<span style='position: relative; bottom: 9px;'>MINHA AGENDA</span>&nbsp;&nbsp;&nbsp;<img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
		//$html .= "<div onclick=\" location = '../index.php?actionType=galeria'\">&nbsp;&nbsp;<span style='position: relative; bottom: 9px;'>FOTOS</span>&nbsp;&nbsp;&nbsp;<img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
		$html .= "<div style='float: left; position: relative; bottom: 10px;' onmouseover=\"javascript: showMenu();\" onmouseout=\"javascript: showMenuOut();\">";
			...
			$html .= "<div>SOBRE O AGORA F¡CIL<span class='menufilete' style='z-index: 100;'>&nbsp;<img border='0' alt='0' src='http://www.maravista.com.br/image/separator.png' alt='' border='0' style='position: relative; top: 10px'/>&nbsp;</span></div>";
			...
			$html .= "</ul>";                                                                  
		$html .= "</div>";                                                                     
		//$html .= "<div onclick=\" location = '../index.php?actionType=videos'\">&nbsp;&nbsp;<span style='position: relative; bottom: 9px;'>VIDEOS</span>&nbsp;&nbsp;&nbsp;<img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
		//$html .= "<div onclick=\" location = '../index.php?actionType=faleconosco'\">&nbsp;&nbsp;<span style='position: relative; bottom: 9px;'>FALE CONOSCO&nbsp;&nbsp;&nbsp;</span><img src='http://www.maravista.com.br/image/separator.png' border='0' alt='0'/>&nbsp;&nbsp;</div>";
...
{                                                                                              
	$mlt = "<table class='Tablemaster'>";                                                                          
		$mlt .= "<tr>";                                                                        
			                                                                                   
			$mlt .= "<td valign='top' class='Lists'>";                                                       
			 
				$mlt .= getNavPrincipal ();
				
			$mlt .= "</td>";                                                                   
			                                                                                   
			$mlt .= "<td valign='top' class='Listw'>";                                                       
			                                                                                   
				$mlt .= getH3title ( $title );                                     
				$mlt .= $html;                                                               
				$mlt .= "<div class='ResetFloat'></div>";	 
	...
	if($_GET['actionType'] != "bem.vindo" )
	{
		$h3 = "<div class='Ultituloback'>";                                                         
			$h3 = "<div class='Litituloback'>";                                                     
				...
				$h3 .= "<div class='Maintitle Btnback' style='cursor: pointer;' onclick=\"javascript:history.go(-1);\"><img src='http://www.maravista.com.br/image/ico_back.png' alt='' border='' width='30px'/></div>";                 
			$h3 .= "</div>";
...
{	                                                                                           
	...
	$conta .= "<div>";                                                                         
		$conta .= "<ul class='SbNav'>";                                                        
			$conta .= "<li class='Exb'><h3><img src='http://www.maravista.com.br/image/dadosdaconta.png' border='0' alt=''/></h3></li>";
...
{	                                                                                           
	...
	$conta .= "<div>";                                                                         
		$conta .= "<ul class='SbNav'>";                                                        
			$conta .= "<li><h3><img src='http://www.maravista.com.br/image/dadosdaconta.png' border='0' alt=''/></h3></li>";
...
{                                                                                              
	...
	//return "<input type='image' name='submit' src='http://www.maravista.com.br/image/novas/ENVIAR.png' alt='Bot„o Enviar'/>";
										...
										$mr .="<tr>";                                          
											$mr .="<td valign='top'>";                         
												...
												{                                              
													...
													$mr .= "<div style='cursor: pointer;' onclick=\" window.location = 'index.php?actionType=colunistas$getcodcolunista&codnoticia=$noticia->CODNOTICIA&codcategorianoticia=$noticia->CODCATEGORIANOTICIA'\"><img src='http://www.maravista.com.br/image/novas/bt_leiamais.gif' alt='Leia Mais' border='0'/></div>";	
												}                                              
												else                                           
												{                                              
													$mr .= "<div style='cursor: pointer;' onclick=\" window.location = 'index.php?actionType=noticias&codnoticia=$noticia->CODNOTICIA&codcategorianoticia=$noticia->CODCATEGORIANOTICIA'\"><img src='http://www.maravista.com.br/image/novas/bt_leiamais.gif' alt='Leia Mais' border='0'/></div>";	
												}                                              
											$mr .="</td>";                                     
											$mr .="<td  valign='top'>";                        
									...
									$mr .="<table>";                                           
										$mr .="<tr>";                                          
											...
											$mr .="<td  valign='top'>";                        
												$string = $video->TITULO;                      
												$string = substr($string, 0, 40);              
												$mr .= "<div style='cursor: pointer;' onclick=\" window.location = 'index.php?actionType=videos&codvideo=$video->CODVIDEO&codcategorianoticia=$video->CODCATEGORIANOTICIA'\"><img src='http://www.maravista.com.br/image/novas/video.png' alt='Ver Video' border='0' width='50%'/></div>";	
												$mr .= "<div style='color: #1a63a8; font-size: 15px; text-align: left;'>$string ...</div>";
											$mr .="</td>";                                     
										$mr .="</tr>";                                         
									$mr .="</table>";                                          
...
{                                                                                              
	...
	if( (int) $nota == 5 )                                                                     
	{                                                                                          
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
	...
	{                                                                                          
		...
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOff.gif' border='0' alt='Estrela'/>";     
	}                                                                                          
	elseif( (int) $nota == 3 )                                                                 
	{                                                                                          
		$str .= "<img src='http://www.maravista.com.br/image/novas/CommentStarOn.gif' border='0' alt='Estrela'/>";      
									...
									$mr .="<table>";                                           
										$mr .="<tr>";                                          
											...
											//$mr .="<td  valign='top'>";                      
												...
												$string = substr($string, 0, 40);              
												$mr .= "<div style='cursor: pointer;' onclick=\" window.location = 'index.php?actionType=agenda&codagenda=$agenda->CODAGENDA&codcategoriaagenda=$agenda->CODCATEGORIAAGENDA'\"><img src='http://www.maravista.com.br/image/novas/agendaico.jpg' alt='Ver Agenda' border='0' width='50%'/></div>";	
												$mr .= "<div style='color: #1a63a8; font-size: 15px; text-align: left;'>$string ...</div>";
											$mr .="</td>";                                     
										$mr .="</tr>";                                         
									$mr .="</table>";                                          
									...
									$mr .="<table>";                                           
										$mr .="<tr>";                                          
											...
											//$mr .="<td  valign='top'>";                      
												$string = $agenda->DESCRICAO;                  
												$string = substr($string, 0, 40);              
												$mr .= "<div style='cursor: pointer;' onclick=\" window.location = 'index.php?actionType=utilidade.publica&codagenda=$agenda->CODAGENDA&codcategoriaagenda=$agenda->CODCATEGORIAAGENDA'\"><img src='http://www.maravista.com.br/image/novas/agendaico.jpg' alt='Ver Agenda' border='0' width='50%'/></div>";	
												$mr .= "<div style='color: #1a63a8; font-size: 15px; text-align: left;'>$string ...</div>";
											$mr .="</td>";                                     
										$mr .="</tr>";                                         
									$mr .="</table>";                                          
...
function linha($link, $name, $value, $image)                                                   
{                                                                                              
	$li .="<div class='Itemmenu' ><a href=\"$link\">$name</a></div>";                                                                                           
	return $li;                                                                                
}                                                                                              
...
function getInternacionalizacao()
{
	$li = "<div class='ShowBandeiras'>";
		...
		$li .= "<div class='ShowBandeirasInter flag_eng'>";
			$li .= "<form name='Liinglesform' id='Liinglesform' method='post' action='$link[1]'>";
				$li .= "<img class='btn_submit ShowInputBandeiras n' title='".getLabel('LABEL_INGLES', $_SESSION['LANGUAGE'])."' alt='".getLabel('LABEL_INGLES', $_SESSION['LANGUAGE'])."' src='http://www.maravista.com.br/image/eua.jpg'/>";
                        $li .= "<img class='btn_submit ShowInputBandeiras bw' title='".getLabel('LABEL_INGLES', $_SESSION['LANGUAGE'])."' alt='".getLabel('LABEL_INGLES', $_SESSION['LANGUAGE'])."' src='http://www.maravista.com.br/image/eua_bw.jpg'/>";
				$li .= "<input type='hidden' value='INGLES' name='LANGUAGE'/>";
				$li .= "<input type='hidden' value='FORMLANGUAGE' name='FORMLANGUAGE'/>";
			$li .= "</form>";
		$li .= "</div>";
		
		$li .= "<div class='ShowBandeirasInter flag_esp'>";
			$li .= "<form name='Liespanholform' id='Liespanhouform' method='post' action='$link[1]'>";
				$li .= "<img class='btn_submit ShowInputBandeiras n' title='".getLabel('LABEL_ESPANHOL', $_SESSION['LANGUAGE'])."' alt='".getLabel('LABEL_ESPANHOL', $_SESSION['LANGUAGE'])."' src='http://www.maravista.com.br/image/espanha.jpg'/>";
                        $li .= "<img class='btn_submit ShowInputBandeiras bw' title='".getLabel('LABEL_ESPANHOL', $_SESSION['LANGUAGE'])."' alt='".getLabel('LABEL_ESPANHOL', $_SESSION['LANGUAGE'])."' src='http://www.maravista.com.br/image/espanha_bw.jpg'/>";
				$li .= "<input type='hidden' value='ESPANHOL' name='LANGUAGE'/>";
				$li .= "<input type='hidden' value='FORMLANGUAGE' name='FORMLANGUAGE'/>";
			$li .= "</form>";
		$li .= "</div>";
		
		$li .= "<div class='ShowBandeirasInter flag_brasil'>";
			$li .= "<form name='Liportuguesfrom' id='Liportuguesfrom' method='post' action='$link[1]'>";
				$li .= "<img class='btn_submit ShowInputBandeiras n' title='".getLabel('LABEL_PORTUGUES', $_SESSION['LANGUAGE'])."' alt='".getLabel('LABEL_PORTUGUES', $_SESSION['LANGUAGE'])."' src='http://www.maravista.com.br/image/brasil.jpg'/>";
                        $li .= "<img class='btn_submit ShowInputBandeiras bw' title='".getLabel('LABEL_PORTUGUES', $_SESSION['LANGUAGE'])."' alt='".getLabel('LABEL_PORTUGUES', $_SESSION['LANGUAGE'])."' src='http://www.maravista.com.br/image/brasil_bw.jpg'/>";
