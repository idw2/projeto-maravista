...
#foi usado essa rotina no comeco para evitar prints indevidos na tela
if ( $_GET["actionType"] == "reservas.continue"){
...
//$html .= "<script type='application/javascript' src='./script/fastclick.js'></script>";
//$html .= "<script>
...
|| $_GET['actionType'] == 'eventos.view' || $_GET['actionType'] == 'quartos.resultado' || $_GET['actionType'] == 'tarifas' || $_GET['actionType'] == 'pacotes-e-promocoes' || $_GET['actionType'] == 'facilidades.servicos.view' || $_GET['actionType'] == 'galeria') {
