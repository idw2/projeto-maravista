	...
	$html .= "<script type='text/javascript'>";
			...
			$html .= "$(window).resize(function(){"
				...
				. "}});";
                       ...
                       $html  .= "$('#eventos_iframe').ready(function(){ $(window).resize(); });";
			$html .= "$(document).ready(function(){"
                    ...
                    return text.substr(0, 175)+' ...';
                          ...
                          //. "$('.banner-home').rcarousel({width: 1000});"
                          . "var win = $('.divFrameEvent').width();"
                          . "var win2 = Math.round(win/2);"
                          . "wind = $('body').width();"
                          . "if(wind < 1179){"
			...
			$html .= "var url = window.location.href;
				...
				$('.LinksMenu a').filter(function() {
                  ...
                  $html .="if(wind > 1550){"
                          ...
                          //. "$('.banner-home .Imagem').css('height', bannerH );"
                          . "}";
			...
			$html .= "
                                ...
                                )
				{
					...
					$(window).scroll(function(){
						...
						var fotpos = $('.footer_container_out').offset().top-680;
                  ...
                  }if( $_GET['actionType'] == "reservas.analisa" )
			{
                  ...
                  if( $_GET['actionType'] == "facilidades.servicos.view" ){
                  $html .= "$('.fb_ne').fancybox({
                              prevEffect	: 'none',
                              nextEffect	: 'none',
                              closeBtn		: false,
