...
$html .= "<div class='HiddenDiv painel'>";
	...
	$html .= "<table>";
		...
		$html .= "<tr>";	
			...
			$html .= "<td>";	
				$html .= "<input type='hidden' class='ScreenOptionOk screen_option_3_ok' name='screen_option_3_ok' value='NOACTION'/>";	
			$html .= "</td>";	
		...
		$html .= "<tr>";	
			...
			$html .= "<td class='InformePessoas'>";	
				...
				$html .= "<select name='screen_pessoa_3' id='screen_pessoa_3' class='n_pessoas'>";
