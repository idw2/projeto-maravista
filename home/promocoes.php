...
$html .= "<div class='pacotes_item'>";
	...
	$html .= "<div class='pacotes_mostra hidden-information-".$i."'>";				
		...
		$html .= "<div class='pacotes_right'>";
			...
			$html .= "<form  onSubmit='return false' id='formReserva_".$i."' name='formReserva' method='post' action='$dados_relevantes->HTTP/contato'>";
				/*
				...
				$html .= "<div class='pacotes_select_pessoas field_reserva'>";
                          ...
                          $html .= "<select name='crianca_".$i."' id='crianca_".$i."' class='pte_pessoas criancas_select  field_reserva-select' data-more='crianca_".$i."'>";
				...
				$html .= "<span class='image-loading' style='display: none;'>";
					//$html .= "<img src='../image/Loading.gif' alt='' title='Loading...' style='width: 12%'/>";
				$html .= "</span><br/>";
					
				$html .= "<div class='active-crianca-".$i." criancas_more' style='display: none;' data-more='crianca_".$i."'>";  
					$html .= "<div class='pacotes_select_pessoas field_reserva'>";
			...
			$html .= "</div>";
                  ...
                  $html .= "<script>
                              $('.criancas_select').change(function() {
                                ...
                                if ($(this).val() == '1') {
                                  $('.criancas_more[data-more='+more+']').fadeIn(250);
                                } else {
                                  $('.criancas_more[data-more='+more+']').fadeOut(250);
                                }
                              });
                              </script>";
