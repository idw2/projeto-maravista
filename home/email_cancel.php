				...
				switch($guest->FAIXA_ETARIA)
{
	...
	WHERE central_emails.CODCENTRALEMAILS='8C2AFB0EF052D949C8A6D4771413F004'");
	...
	$assunto = getLabel('LABEL_RESERVA_CANCELADA', $_SESSION['LANGUAGE'])." - Cod: ".$_POST["N_CONHECIMENTO"];
