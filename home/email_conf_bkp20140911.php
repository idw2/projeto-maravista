				...
				switch($guest->FAIXA_ETARIA)
{
	...
	$mail->Username = "no-replay-designlab@bol.com.br"; 

	$mail->Password = 'ggix38'; 

	$mail->From = "no-replay-designlab@bol.com.br"; 

	$mail->FromName = "Pousada Maravista";
	

	$to      = $pessoa->EMAIL;

	$subject = getLabel('LABEL_RESERVA_CONFIRMADA', $_SESSION['LANGUAGE'])." - Cod: ".$reserva->N_CONHECIMENTO;

	$toname  = getLabel('LABEL_RESERVA_CONFIRMADA', $_SESSION['LANGUAGE'])." - Cod: ".$reserva->N_CONHECIMENTO;
	...
	$mail->AddBCC('contato@maravista.com.br', 'Marcel');

	$mail->IsHTML(true);

	$mail->CharSet = 'iso-8859-1';

	$mail->Subject  = getLabel('LABEL_RESERVA_CONFIRMADA', $_SESSION['LANGUAGE'])." - Cod: ".$reserva->N_CONHECIMENTO;
