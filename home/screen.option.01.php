...
$html .= "<div class='HiddenDiv painel'>";
	...
	$html .= "<div class='HiddenDiv_top'>";
		...
		if( (int)$_POST["nQuartos"] > 1 )
		{
			//$html .= "<label class='LabelAcomodacaoTitle right'>".getLabel('LABEL_PESSOAS', $_SESSION['LANGUAGE'])."</label>";
		}
		elseif( (int)$_POST["pessoas"] == 0 )
		{
			//$html .= "<label class='LabelAcomodacaoTitle right'>".getLabel('LABEL_PESSOAS', $_SESSION['LANGUAGE'])."</label>";
		}
	$html .= "</div>";
	...
	$html .= "<table>";
		...
		$html .= "<tr>";	
			...
			$html .= "<td>";	
				$html .= "<input type='hidden' class='ScreenOptionOk screen_option_0_ok' name='screen_option_0_ok' value='NOACTION'/>";	
			$html .= "</td>";	
		...
		$html .= "<tr >";	
			...
			if( (int)$_POST["nQuartos"] == 1 )
			{
				$html .= "<td class='InformePessoas'>";
					$html .= "<input type='hidden' name='screen_pessoa_0' id='screen_pessoa_0' class='n_pessoas' value='".$_POST["pessoas"]."'/>";
				$html .= "<td>";
			}
			elseif( (int)$_POST["nQuartos"] > 1 )
			{
				$html .= "<td class='InformePessoas'>";	
                    
					$html .= "<label class='LabelAcomodacaoTitle'>".getLabel('LABEL_PESSOAS', $_SESSION['LANGUAGE'])."</label>";
					$html .= "<select name='screen_pessoa_0' id='screen_pessoa_0' class='n_pessoas'>";
			...
			elseif( (int)$_POST["pessoas"] == 0 )
			{
				$html .= "<td class='InformePessoas'>";	
					...
					$html .= "<label class='LabelAcomodacaoTitle'>".getLabel('LABEL_PESSOAS', $_SESSION['LANGUAGE'])."</label>";
					$html .= "<select name='screen_pessoa_0' id='screen_pessoa_0'>";
						$html .= "<option value='1'>1</option>";		
						$html .= "<option value='2'>2</option>";		
						$html .= "<option value='3'>3</option>";		
						$html .= "<option value='4'>4</option>";		
