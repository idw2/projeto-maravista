<?php
...

	{
...

		{
...

			{
				...
				$erro = "<br/>* A <b>\"Senha atual\"</b> informada não confere!";
	...
	$pi = "<form name='formCpf' method='post' action='index.php?actionType=alterar.senha'>";
		...
		$pi .= "<div class='Userlabel'>".getLabel('LABEL_LOGIN', $_SESSION['LANGUAGE']).":</div>";

		$pi .= "<div class='EntradaTextForm'>$_SESSION[LOGIN]</div>";

		$pi .= "<div class='Userlabel'><br/></div>";

		$pi .= "<div class='EntradaTextForm' style='margin-bottom: 3px;'><input type='password' name='senha_atual' value='' maxlength='40' placeholder='".getLabel('LABEL_SENHA', $_SESSION['LANGUAGE'])."'/></div>";

		$pi .= "<div class='EntradaTextForm' style='margin-bottom: 3px;'><input type='password' name='senha' value='' maxlength='40' placeholder='".getLabel('LABEL_SENHA_NOVA', $_SESSION['LANGUAGE'])."'/></div>";

		$pi .= "<div class='EntradaTextForm' style='margin-bottom: 3px;'><input type='password' name='repetirsenha' value='' maxlength='40' placeholder='".getLabel('LABEL_REPETIR_SENHA', $_SESSION['LANGUAGE'])."'/></div>";
		...
		$pi .="<div><input type='submit' value='".getLabel('LABEL_ENVIAR', $_SESSION['LANGUAGE'])."'/></div>";
	...
	$html .= getNavegacao($pi, getLabel('LABEL_ALTERAR_SENHA', $_SESSION['LANGUAGE']));
