	...
	else
	{
		$html .= "<div class='LoginUser'>";
			if(!empty($_SESSION['NOME']))
			{
				...
				$html .= "<div class='LoginLabel'><span class='Seta'>õõ</span>$nome[0]</div>";
			}
			$html .= "<div class='LoginLabel'><span onclick=\"location='index.php?actionType=mypapers'\"><span class='Seta'>õõ</span>".getLabel('LABEL_GERENCIAMENTO', $_SESSION['LANGUAGE'])."</span></div>";
			$html .= "<div class='LoginLabel'><span onclick=\"location='index.php?actionType=logout'\"><span class='Seta'>õõ</span>".getLabel('LABEL_SAIR', $_SESSION['LANGUAGE'])."</span></div>";
