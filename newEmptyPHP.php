...
<?php 
  if(is_category('ensaios')){
   echo '<link href="http://site1383332957.hospedagemdesites.ws//site/wp-includes/css/folha-ensaios.css?v=0.25" rel="stylesheet" type="text/css" />';
  ?> 
    <script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script> 
  <?php
  
   echo '<script type="text/javascript" src="http://site1383332957.hospedagemdesites.ws/scripts/jquery.mousewheel-3.0.6.pack.js?v=2.1.5"></script>';
   echo '<link rel="stylesheet" href="http://site1383332957.hospedagemdesites.ws/css/jquery.fancybox.css?v=2.1.5" type="text/css"/>';
   echo '<script type="text/javascript" src="http://site1383332957.hospedagemdesites.ws/scripts/jquery.fancybox.pack.js?v=2.1.5"></script>';
    ?>

    <?php
   echo '<script type="text/javascript" src="http://www.site1383332957.hospedagemdesites.ws/site/wp-includes/theme-compat/script-ensaios.js?v=0.1"></script>';
}
if(is_page('contato')){
   echo '<link href="http://www.site1383332957.hospedagemdesites.ws/site/wp-includes/css/folha-contato.css?v=0.1" rel="stylesheet" type="text/css" />';
		...
		<ul class="featured-items slider">
			...
			<li class="slide">
				...
				<?php 
                                ...
                                if ( get_post_gallery() ) :
                                    ...
                                    {   
                                        ...
                                        ?>
                                        <a class="fancybox" href="<?php echo $full; ?>" rel="<?php echo $post->ID ?>">
                                            <div class="slider_img_container">
                                            <img src="<?php echo $g; ?>" class="attachment-post-thumb wp-post-image" alt="" />
                                            </div>
                                        </a>    
                                        <?php
				...
				<div class="featured-text">
					...
					<span class="featured-small"><?php the_title(); ?></span>
